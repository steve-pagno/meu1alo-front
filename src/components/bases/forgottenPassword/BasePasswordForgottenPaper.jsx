...
const BasePasswordForgottenPaper = ({ userType, userTypeTitle }) => {
    const styles = useBasePasswordForgottenStyles();
    const { loading, onSubmit, register } = useBasePasswordForgottenController(userType);
    ...
    return (
        <>
            ...
            <Box sx={{ backgroundColor: '#ffffff', display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
                {/* Seção Superior de Recuperação com Fundo Roxo e Ondas Animadas */}
                <Box sx={{
                    ...styles.container,
                    alignItems: 'center',
                    display: 'flex',
